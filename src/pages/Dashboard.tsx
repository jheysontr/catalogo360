...
import { Loader2, AlertTriangle, Rocket, ShieldAlert, X } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-secondary/20">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        />
          ...
          {impersonation && (
            <div className="mx-3 sm:mx-6 lg:mx-8 mt-3 sm:mt-6 lg:mt-8 mb-0 rounded-xl border border-amber-300 bg-amber-50 dark:border-amber-700 dark:bg-amber-950/40 p-3 flex items-center gap-3">
              <ShieldAlert className="h-5 w-5 text-amber-600 dark:text-amber-400 shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-amber-800 dark:text-amber-200">
                  Modo administrador — gestionando "{impersonation.storeName}"
                </p>
                <p className="text-xs text-amber-700 dark:text-amber-300">
                  Cualquier cambio se aplica a la tienda del cliente.
                </p>
              </div>
              <Button size="sm" variant="outline" onClick={exitImpersonation} className="gap-1.5 shrink-0">
