        ...
        <div className="container">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
            {["🇧🇴 Bolivia", "🇲🇽 México", "🇦🇷 Argentina", "🇨🇱 Chile", "🇵🇪 Perú", "🇨🇴 Colombia", "🇺🇾 Uruguay"].map((country) => (
              <span key={country} className="text-sm font-medium text-muted-foreground/70">{country}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28">
        <div className="container">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mx-auto max-w-3xl rounded-2xl border bg-gradient-to-br from-primary/10 via-accent/30 to-secondary/50 p-10 text-center shadow-lg sm:p-16"
          >
            <h2 className="font-display text-3xl font-bold text-foreground sm:text-4xl">
