  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {sfConfig.template === "modern" ? (
        ...
        /* Classic template - original banner */
      ...
      {/* Info/Share buttons for modern/minimal templates */}
      {sfConfig.template !== "classic" && (
        <div className="container flex justify-center gap-2 px-4 py-3">
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => setInfoOpen(true)}>
