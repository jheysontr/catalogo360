...
export const TEMPLATE_THEMES: Record<string, TemplateTheme> = {
  ...
  elegante: {
    id: "elegante",
    label: "Boutique",
    description: "Cinematográfico, full-bleed, tarjetas overlay",
    emoji: "✨",
    bannerGreeting: "Colección",
    bannerRounded: "rounded-none",
    bannerOverlayOpacity: "opacity-15",
    bannerStyle: "full",
    bannerHeight: "h-56",
    cardRounded: "rounded-none",
    ...
    gridGap: "gap-x-3 gap-y-8 sm:gap-x-4 sm:gap-y-12",
    pillRounded: "rounded-none",
    pillStyle: "underline",
    headerBorder: false,
    ctaText: "Comprar",
