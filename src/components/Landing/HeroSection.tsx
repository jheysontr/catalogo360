...
const HeroSection = () => (
  <>
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-background via-background to-secondary/40 py-20 sm:py-28 lg:py-36">
      <div className="pointer-events-none absolute -top-40 right-10 h-[500px] w-[500px] rounded-full blur-3xl bg-primary/6" />
      <div className="pointer-events-none absolute bottom-0 -left-20 h-[400px] w-[400px] rounded-full blur-3xl bg-accent/25" />
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[300px] w-[300px] rounded-full blur-3xl bg-primary/4" />
      ...
      <div className="container relative z-10">
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          <div className="text-center lg:text-left">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border bg-card/80 backdrop-blur-sm px-4 py-2 text-sm text-muted-foreground shadow-sm">
          ...
          <div className="relative mx-auto flex w-full max-w-lg items-end justify-center gap-4 lg:max-w-none">
            ...
            <div className="w-20 overflow-hidden rounded-[16px] border-2 border-border bg-card shadow-[0_15px_40px_-10px_rgba(0,0,0,0.2)] lg:w-24 dark:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.45)]">
            ...
            <div className="absolute -right-2 top-6 z-20 rounded-xl border bg-card/95 backdrop-blur-sm p-3 shadow-lg lg:-right-8">
